...
\definecolor{synt}{RGB}{255,0,0}
\definecolor{sem}{RGB}{0,160,138}
...
\newcommand{\synt}[1]{\textcolor{synt}{#1}}
\newcommand{\sem}[1]{\textcolor{sem}{#1}}
	...
	\begin{titlepage}
		...
		{\Large 
		  Ce mémoire est le fruit d’un travail approuvé par le jury de soutenance et réalisé dans le but d’obtenir le diplôme de Master \textbf{Sciences du langage, Parcours Theoretical and Experimental Linguistics and Phonetics}. Ce document est mis à disposition de l’ensemble de la communauté universitaire élargie.
	...
	\begin{titlepage}
	  ...
	  \begin{center}
	    \begin{tabular}{lll}
	      Lisa Brunetti & \hspace*{40pt} & President  \\				
	      Anne Abeillé  & \hspace*{40pt} & Supervisor  \\				
	      Olivier Bonami & \hspace*{40pt} & Expert  \\				
	    \end{tabular}\\[1cm]
	  \end{center}
	  \newpage
	\end{titlepage}

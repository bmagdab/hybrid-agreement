...
Considering the effect of apposition placement on the choice of agreement, we can look at how the proportions of semantic agreement change if we exclude occurrences with apposition first, because the speakers agree the gender of the target with the gender of apposition and not the semantic gender of the controller. Figure \ref{fig:NOAPP-semantic-in-targets} is identical to Figure \ref{fig:semantic-in-targets}, only with occurrences of profession nouns with appositions first excluded.

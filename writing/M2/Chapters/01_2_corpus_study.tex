...
\begin{figure}[H]
  \centering
  \includegraphics[width=\linewidth]{images/big-model.png}
  \caption{Model with all types of nouns}
\end{figure}

\begin{figure}[H]
  \centering
  \includegraphics[width=\linewidth]{images/depr-model.png}
  \caption{Model with depreciative forms}
\end{figure}

\begin{figure}[H]
  \centering
  \includegraphics[width=\linewidth]{images/gend-model.png}
  \caption{Model with gendered nouns}
\end{figure}

\begin{figure}[H]
  \centering
  \includegraphics[width=\linewidth]{images/prof-model.png}
  \caption{Model with profession nouns}
\end{figure}

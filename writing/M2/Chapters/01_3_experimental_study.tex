...
% Random effects:
%  Groups      Name        Variance Std.Dev.
%  trial_index (Intercept) 0.0165   0.1284  
%  id          (Intercept) 1.6869   1.2988  
%  item        (Intercept) 0.7912   0.8895  
%  age         (Intercept) 0.0000   0.0000  
% Number of groups:  trial_index 60,  id 25,  item 24,  age 3 

% Coefficients:
%                                        Estimate Std. Error z value Pr(>|z|)  
% agreementsemantic                        0.5478     0.3254   1.684   0.0923 .
% orderControllerFirst                    -0.1938     0.3393  -0.571   0.5679  
% target_typeRelPron                       0.6181     0.3283   1.883   0.0597 .
% agreementsemantic:orderControllerFirst   0.4738     0.4643   1.020   0.3075  
% agreementsemantic:target_typeRelPron    -0.8483     0.4503  -1.884   0.0596 .
% ---
% Signif. codes:  0 ‘***’ 0.001 ‘**’ 0.01 ‘*’ 0.05 ‘.’ 0.1 ‘ ’ 1

% Threshold coefficients:
%     Estimate Std. Error z value
% 1|2   0.8255     0.3989   2.070
% 2|3   2.6065     0.4186   6.226
% 3|4   3.5033     0.4352   8.050
% 4|5   4.9360     0.4889  10.096

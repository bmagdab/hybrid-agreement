...
The results of both experiments with the control conditions for comparison can be found in Figure \ref{fig:exp-main}. 
...
Results from this experiment were also anaylzed with a mixed-effects ordinal regression model, with agreement crossed with order and target type as predictors of acceptability rating and the same random effects as in the general model. 

The list of coefficients from this model can be found in Appendix ?.
...
\begin{table}[h]
  ...
  \begin{tblr}{
    ...
    Agreement & Postnominal predicate & & Prenominal predicate & & Relative pronoun & \\
              & Mean & SD & Mean & SD & Mean & SD \\ 
    Semantic & 1.96 & 1.27 & 1.76 & 1.04 & 1.86 & 1.08 \\ 
    Syntactic & 1.55 & 0.95 & 1.59 & 0.94 & 1.70 & 1.03 \\ 
  \end{tblr}
  \caption{Means and standard deviations for acceptability ratings in all conditions in Experiment 1.}
  \label{tab:exp-prof-summary}
\end{table}
...
% formula: rating ~ noun * agreement * (order + target_type + (1 | id) +  
%     (1 | item) + (1 | trial_index) + (1 | age) + (1 | group))
% data:    .


% Random effects:
%  Groups      Name        Variance  Std.Dev. 
%  trial_index (Intercept) 8.026e-02 2.833e-01
%  id          (Intercept) 1.023e+00 1.011e+00
%  item        (Intercept) 6.151e-01 7.843e-01
%  group       (Intercept) 5.074e-10 2.253e-05
%  age         (Intercept) 0.000e+00 0.000e+00
% Number of groups:  trial_index 60,  id 54,  item 45,  group 6,  age 3 

% Coefficients:
%                                                 Estimate Std. Error z value Pr(>|z|)    
% nounprof                                          3.7672     0.4546   8.287   <2e-16 ***
% agreementsemantic                                 0.5275     0.3156   1.671   0.0946 .  
% orderControllerFirst                             -0.1432     0.3301  -0.434   0.6644    
% target_typeRelPron                                0.5353     0.3190   1.678   0.0933 .  
% nounprof:agreementsemantic                       -0.6341     0.4105  -1.545   0.1224    
% nounprof:orderControllerFirst                     0.1067     0.4231   0.252   0.8009    
% nounprof:target_typeRelPron                       0.1422     0.4161   0.342   0.7326    
% agreementsemantic:orderControllerFirst            0.3750     0.4478   0.837   0.4023    
% agreementsemantic:target_typeRelPron             -0.7160     0.4327  -1.655   0.0980 .  
% nounprof:agreementsemantic:orderControllerFirst   0.2532     0.5841   0.433   0.6647    
% nounprof:agreementsemantic:target_typeRelPron     0.4616     0.5768   0.800   0.4235    
% ---
% Signif. codes:  0 ‘***’ 0.001 ‘**’ 0.01 ‘*’ 0.05 ‘.’ 0.1 ‘ ’ 1

% Threshold coefficients:
%     Estimate Std. Error z value
% 1|2   0.8873     0.3448   2.573
% 2|3   2.4190     0.3546   6.821
% 3|4   3.0815     0.3595   8.572
% 4|5   4.3802     0.3698  11.843

% PROF MODEL
% Cumulative Link Mixed Model fitted with the Laplace approximation

% formula: rating ~ agreement * (order + target_type + (1 | id) + (1 | item) +  
%     (1 | trial_index) + (1 | age) + (1 | group))
% data:    .


% Random effects:
%  Groups      Name        Variance Std.Dev.
%  trial_index (Intercept) 0.04385  0.2094  
%  id          (Intercept) 0.62532  0.7908  
%  item        (Intercept) 0.47543  0.6895  
%  group       (Intercept) 0.00000  0.0000  
%  age         (Intercept) 0.00000  0.0000  
% Number of groups:  trial_index 60,  id 29,  item 24,  group 6,  age 3 

% Coefficients:
%                                        Estimate Std. Error z value Pr(>|z|)  
% agreementsemantic                      -0.09523    0.25584  -0.372   0.7097  
% orderControllerFirst                   -0.03820    0.25593  -0.149   0.8814  
% target_typeRelPron                      0.63759    0.25970   2.455   0.0141 *
% agreementsemantic:orderControllerFirst  0.60186    0.36529   1.648   0.0994 .
% agreementsemantic:target_typeRelPron   -0.25598    0.37176  -0.689   0.4911  
% ---
% Signif. codes:  0 ‘***’ 0.001 ‘**’ 0.01 ‘*’ 0.05 ‘.’ 0.1 ‘ ’ 1

% Threshold coefficients:
%     Estimate Std. Error z value
% 1|2  -2.4763     0.3027  -8.181
% 2|3  -1.2517     0.2828  -4.425
% 3|4  -0.7100     0.2791  -2.543
% 4|5   0.5538     0.2788   1.986
...
% Random effects:
%  Groups      Name        Variance Std.Dev.
%  trial_index (Intercept) 0.01776  0.1333  
%  id          (Intercept) 1.12671  1.0615  
%  item        (Intercept) 0.80517  0.8973  
%  group       (Intercept) 0.66676  0.8166  
%  age         (Intercept) 0.00000  0.0000  
% Number of groups:  trial_index 60,  id 25,  item 24,  group 6,  age 3 

% Coefficients:
%                                        Estimate Std. Error z value Pr(>|z|)  
% agreementsemantic                        0.5545     0.3259   1.701   0.0889 .
% orderControllerFirst                    -0.1881     0.3399  -0.554   0.5799  
% target_typeRelPron                       0.6164     0.3289   1.874   0.0610 .
% agreementsemantic:orderControllerFirst   0.4655     0.4652   1.001   0.3170  
% agreementsemantic:target_typeRelPron    -0.8465     0.4512  -1.876   0.0606 .
% ---
% Signif. codes:  0 ‘***’ 0.001 ‘**’ 0.01 ‘*’ 0.05 ‘.’ 0.1 ‘ ’ 1

% Threshold coefficients:
%     Estimate Std. Error z value
% 1|2   0.7683     0.5074   1.514
% 2|3   2.5486     0.5226   4.877
% 3|4   3.4458     0.5358   6.431
% 4|5   4.8817     0.5801   8.415

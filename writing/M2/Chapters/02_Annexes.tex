...
\section{Coefficients from statistical modeling of the corpus data}
\begin{table}[H]
  \centering
  \begin{tblr}
    {vlines, hlines,
...
\section{Information for participants in the experiments.}
\begin{figure}[H]
  \centering
...
\newpage
\section{Experimental, filler and control items from the experiments}
\input{Chapters/app-items.tex}

\section{Coefficients from statistical modeling of the experimental data}

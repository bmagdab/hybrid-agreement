...
%% \usepackage{ascii} % normal monospace font
...
\begin{document}	
	...
	\begin{titlepage}
		...
		\begin{center}
		  ...
		  %% By\\
			...
			{ \Large \bfseries Hybrid gender agreement pattern in Polish}
			\vspace*{20pt}
            
			{ \large Under the supervision of Professor Anne Abeillé}
	...
	\input{Chapters/01_1_theoretical_background}
	
	\input{Chapters/01_2_methodology}

	\input{Chapters/01_3_results}

	\input{Chapters/01_4_discussion}

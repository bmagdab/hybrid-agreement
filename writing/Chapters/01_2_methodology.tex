...
The corpus used for this study was the 300M subcorpus of the National Corpus of Polish \citep{przepiorkowski_narodowy_2012}, which was parsed using Trankit \citep{nguyen_trankit_2021}. The dependency trees (conforming to the Universal Dependency standard, henceforth UD) obtained this way were searched for words, which could trigger hybrid agreement: profession nouns, socially gendered nouns and depreciative forms of M1 nouns. The subsections below describe how those nouns were chosen.
